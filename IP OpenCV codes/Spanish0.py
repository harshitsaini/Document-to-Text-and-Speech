...
import numpy as np
#src_path= 'C://Users//Harshit//Desktop//Initial_img//Machine Printed//Spanish0//'
src_path= 'C://Users//Harshit//Desktop//'
original = src_path+ "harshit.png"
import pytesseract
...
def get_string (img_path):
    ...
    result= pytesseract.image_to_string(Image.open(src_path+'final.png'),lang='spa', config=tessdata_dir_config)
    #os.remove(temp)
    return result

print('-----Start recognize text from image -----')
print(get_string(src_path+ "harshit.png"))
print("-------DONE-------")